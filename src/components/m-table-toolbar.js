...
export function MTableToolbar(props) {
  const [columnButtonAnchorEl, setColumnButtonAnchorEl] = React.useState(null);
          ...
          <span>
            <Tooltip title={localization.showColumnsTitle}>
              <IconButton
                color="inherit"
                onClick={(event) =>
                  setColumnButtonAnchorEl(event.currentTarget)
                }
            ...
            <Menu
              ...
              onClose={(e) => setColumnButtonAnchorEl(null)}
            >
              <MenuItem
                key={'text'}
                disabled
        ...
        {props.exportButton && (
          <span>
            ...
            <Menu
              ...
              onClose={(e) => setExportButtonAnchorEl(null)}
            >
